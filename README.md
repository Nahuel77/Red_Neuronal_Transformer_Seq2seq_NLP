...
Es decir que si dieramos dos veces exactamente la misma entrada, el modelo NLP, aunque en esencia responda lo mismo, lo hara con un lenguaje natural y no dando exactamente las mismas palabras sin cambio alguno.
